 ...
 */
@Component
@ConditionalOnProperty("clients.argument-resolvers.data-class", havingValue = "true")
class ClientDataArgumentResolver : HttpServiceArgumentResolver {
